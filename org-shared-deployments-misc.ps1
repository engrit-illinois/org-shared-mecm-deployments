...
Compare-Object -ReferenceObject $left -DifferenceObject $right -Property Application,Collection -IncludeEqual
...
# See: https://uofi.atlassian.net/wiki/spaces/engritinstruction/pages/260571972/EWS+procedure+for+renaming+AD+OUs
